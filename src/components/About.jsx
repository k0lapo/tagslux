...
const About = () => {
  return (
    <div className="py-5 px-4 md:px-8 mx-auto container"> {/* Adjusted padding */}
      <div className="shadow-sm rounded-lg p-4 md:p-8"> {/* Adjusted padding */}
        <section className="text-justify mb-8 md:mb-16"> {/* Adjusted margin */}
          <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-center">About</h2> {/* Adjusted font size and margin */}
          <p className="text-base md:text-lg text-gray-900 mb-2 md:mb-4"> {/* Adjusted font size and margin */}
          ...
          <section className="text-justify mt-10 md:mt-20 mb-8 md:mb-16"> {/* Adjusted margin */}
            <h3 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-center">OFF THE HINGES</h3> {/* Adjusted font size and margin */}
            <p className="text-base md:text-lg text-gray-900 mb-2 md:mb-4"> {/* Adjusted font size and margin */}
            ...
            <div className="text-base md:text-lg text-gray-900 mb-4"> {/* Adjusted font size and margin */}
            ...
            <div className="text-base md:text-lg text-gray-900 mb-4"> {/* Adjusted font size and margin */}
              ...
              <p>
                &quot;Picante&quot; brings the heat with its bold, fiery design. This piece is all about passion and intensity, with striking colors and dynamic shapes that make a powerful statement. &quot;Picante&quot; is for those who are not afraid to stand out and embrace their inner fire.
              </p>
            </div>
            ...
            {/* <div className="text-base md:text-lg text-gray-900 mb-4">
